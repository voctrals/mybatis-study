 ...
 * @author voctrals
 */
public class SqlSessionWithoutMapperInterfaceProcess {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            List<Person> allPerson = sqlSession.selectList("voctrals.study.mybatis.mapper.PersonXMapper.getSomePerson");
